...
if (class_exists('djumlajoomla_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class djumlajoomla_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class djumlajoomla_Sniffs_Commenting_ClassCommentSniff extends djumlajoomla_Sniffs_Commenting_FileCommentSniff
{
