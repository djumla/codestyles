 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class djumlajoomla_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processParams($commentStart)
    {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                // djumlajoomla change: 3 spaces to make it line up with the @return tag with a 2 space gap.
			...
			// djumlajoomla modification to 2 spaces.
