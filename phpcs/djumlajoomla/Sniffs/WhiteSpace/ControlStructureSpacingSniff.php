<?php
/**
 * djumlajoomla_Sniffs_WhiteSpace_ControlStructureSpacingSniff.
 *
 * PHP version 5
 *
 ...
 * @since      12.3
 */
class djumlajoomla_Sniffs_WhiteSpace_ControlStructureSpacingSniff implements PHP_CodeSniffer_Sniff
{
	/**
