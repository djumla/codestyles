<?php
/**
 * djumlalaravel_Sniffs_Functions_StatementNotFunctionSniff.
 *
 ...
 * @since  1.1
 */
class djumlalaravel_Sniffs_Functions_StatementNotFunctionSniff implements PHP_CodeSniffer_Sniff
{
	/**
